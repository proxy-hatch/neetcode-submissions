class Solution:
    def lengthOfLongestSubstring(self, s: str) -> int:
        """
        Optimal
        Intuition: instead of maintaining a set, maintain a hash table with value as the last seen index. The task is just to rolling count from when the index was last seen + 1, keeping track of the max.
        """
        max_length = 0
